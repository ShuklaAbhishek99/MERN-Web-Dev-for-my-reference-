...
app.get("/demo", (req, res)=>{ 
    res.status(200).render('demo', { title: 'Hey Abhishek', message: 'Hello there and thanks for telling me how to use pubG!' })
});

app.get("/", (req, res)=>{ 
    res.status(200).send("This is homepage of my first express app with Abhishek");
});
