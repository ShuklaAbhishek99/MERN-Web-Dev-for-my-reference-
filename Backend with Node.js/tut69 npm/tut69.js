// ^ means the Exact package version
// ~ means to install patches along with it(i.e 1.0. 2 )/installs the package
// > Means to install latest version of that module
...
// npm install slugify@1.4.5 --> installs a particular version of a package
